...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if(self.loginViewController == nil){
        LoginViewController *temp = [[LoginViewController alloc] initWithNibName:@"LoginViewController" bundle:nil];
        self.loginViewController = temp;
        [temp release];
    }
...
-(void)saveUserState{
    [[NSUserDefaults standardUserDefaults] setObject:self.userState forKey:@"KUserState"];
